...
// Subtle particle network background (visual only — no functionality impact)
function initNetworkBackground() {
    ...
    const particleColor = 'rgba(148, 163, 184, 0.35)';
    const lineColor = 'rgba(37, 99, 235, 0.08)';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Console message
    console.log('%c👋 Hello! Welcome to my portfolio.', 'color: #2563EB; font-size: 16px; font-weight: bold;');
